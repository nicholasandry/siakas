...
import {
  ...
  updateTaxRuleAction,
} from "@/app/(dashboard)/settings/tax-master/actions";
    ...
    <main className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-6 py-10">
      ...
      <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-2xl space-y-3">
          <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Pengaturan / Master Pajak / Edit</p>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-950 md:text-3xl">{group.name}</h1>
                            ...
                            {rule.isActive ? (
                              <form action={deactivateTaxRuleAction}>
                                ...
                                <button
                                  ...
                                  title="Nonaktifkan Aturan Pajak"
                                >
